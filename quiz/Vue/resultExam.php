...
<body>
    ...
    if ($totalQuestion == $countQuestion) {
        ...
        $resultat = $question->AfficheResultat($exam_id, $_SESSION['id_user']);
    }
    ?>
    <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col-md-8">RESULTAT D'EXAMENS</div>
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover">
                    ...
                    ';
                        ...
                        $SumMarks = $userExamQuestion->SumMarks($_SESSION['id_user'], $exam_id);
                    ...
                    ?>
                    <tr>
                        <td align="right"><a href="#" class="btn btn-success">Aller vers l'universite</a></td>
